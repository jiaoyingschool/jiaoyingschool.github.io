...
# be sure to set the paths correctly in the next few lines

$versions{'picserve.cgi'} = "5.1.000";
...
exit;
# normally no need to edit anything below!
########################################################################
sub serve_picture
{
...
#    print get($my_path_to_image);
    ...
    { # stuff in braces loads image all at once
