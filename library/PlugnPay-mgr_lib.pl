...
#
# Copyright 2002-2006  K-Factor Technologies, Inc. and AgoraScript  All Rights Reserved.
# Donated by Plug 'n Pay Technologies, Inc. (based on previous modules)
# Last Updated: May 5, 2006 by Mister Ed

# Notes:
# -- Includes Enhanced Color Selections

$versions{'PlugnPay-mgr_lib.pl'} = "5.0.000";
...
sub PlugnPay_settings {
  if ($sc_gateway_name eq "PlugnPay") {
    ...
    $sc_plugnpay_verify_message_temp = &my_escape($in{'sc_plugnpay_verify_message'});
    ...
    print (GW "\$sc_plugnpay_submit = '$in{'sc_plugnpay_submit'}';\n");
    print (GW "\$sc_plugnpay_change = '$in{'sc_plugnpay_change'}';\n");
    print (GW "\$sc_plugnpay_verify_message = qq'$sc_plugnpay_verify_message_temp';\n");
    ...
    print (GW "\$sc_plugnpay_order_desc = '$in{'sc_plugnpay_order_desc'}';\n");
...
<TABLE WIDTH=580>
  ...
  <TR>
    <TD WIDTH=580><FONT FACE=ARIAL>PlugnPay Settings $msg</FONT></TD>
  </TR>
</TABLE>
</CENTER>
...
<TABLE BORDER=0 CELLPADDING=1 CELLSPACING=0 WIDTH=580 BORDER=0>
  ...
  <TR>
    <TD width="80%">Subject line of AgoraCart email sent to merchant:</TD>
    <TD width="20%"><INPUT NAME="sc_plugnpay_order_desc" TYPE="TEXT" SIZE=30 VALUE='$sc_plugnpay_order_desc'></TD>
  </TR>
  ...
  <TR>
    <TD COLSPAN=2>URL of 'Submit to PlugnPay' button:<br></TD>
  </TR>
  <TR>
    <TD COLSPAN=2 align="right"><INPUT NAME="sc_plugnpay_submit" TYPE="TEXT" SIZE=60 VALUE='$sc_plugnpay_submit'><br></TD>
  </TR>
  
  <TR>
    <TD COLSPAN=2>URL of 'Make Changes' button:<br></TD>
  </TR>
  <TR>
    <TD COLSPAN=2 align="right"><INPUT NAME="sc_plugnpay_change" TYPE="TEXT" SIZE=60 VALUE='$sc_plugnpay_change'><br></TD>
  </TR>
  ...
  <TR>
    <TD COLSPAN=2>Message at the top of the Verify Order table:<br></TD>
  </TR>
  <TR>
    <TD COLSPAN=2 align="right"><TEXTAREA NAME="sc_plugnpay_verify_message" ROWS=4 COLS=65 wrap=soft>$sc_plugnpay_verify_message</TEXTAREA></TD>
  </TR>
  
  <TR>
    <TD COLSPAN=2><br><HR width=80%><br></TD>
  </TR>
  ...
  <TR>
    <TD COLSPAN=2><br>Business address and phone number (contact information) for your business.  Should be legal address for the business location for full disclosure and other privacy requirements mandated by credit card companies as well as government enitities that require such notices:<br>
    </TD>
  <TR>
    <TD COLSPAN=2 align="right"><TEXTAREA NAME="sc_tos_display_address" cols="68" rows=5 wrap=off>$sc_tos_display_address</TEXTAREA><br>
  </TD>
  </TR>
  ...
  <TR>
    <TD COLSPAN=2><CENTER>
      ...
      <INPUT TYPE="HIDDEN" NAME="gateway" VALUE="PlugnPay">
