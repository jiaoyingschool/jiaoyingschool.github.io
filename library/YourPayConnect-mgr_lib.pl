#
# For the CC and Check Processing Gateway YourPay Connect, included
# in the base package of agoracart, a GPL-ed program.
#
# Copyright 2000 to date K-Factor Technologies, Inc. 

$versions{'YourPayConnect-mgr_lib.pl'} = "5.0.000";
&add_codehook("gateway_admin_screen","YourPayConnect_mgr_check");
&add_codehook("gateway_admin_settings","YourPayConnect_settings");
$mc_gateways .= "|YourPayConnect";
##############################################################################
sub YourPayConnect_settings {
local($custom_logic);
if ($sc_gateway_name eq "YourPayConnect") {
 ...
 print (GATEWAY  "#\n1\;# We are a Library\n");
 print (GATEWAY  "\$sc_yourpay_submit = '$in{'sc_yourpay_submit'}';\n");
 print (GATEWAY  "\$sc_yourpay_change = '$in{'sc_yourpay_change'}';\n");
 print (GATEWAY  "\$sc_yourpay_verify_message = \"" . 
       &my_escape($in{'sc_yourpay_verify_message'}) . "\";\n");
 print (GATEWAY  "\$sc_yourpay_order_desc = \"" . 
       &my_escape($in{'sc_yourpay_order_desc'}) . "\";\n");
...
$sc_tos_display_address_temp = &my_escape($in{'sc_tos_display_address'});
 ...
 print (GATEWAY  "\$sc_yourpay_top_message = \"" . 
       &my_escape($in{'sc_yourpay_top_message'}) . "\";\n");
...
##############################################################################
sub YourPayConnect_mgr_check {
if ($sc_gateway_name eq "YourPayConnect") {
  &print_YourPayConnect_mgr_form;
  &call_exit;
 }
}
##############################################################################
sub print_YourPayConnect_mgr_form {
	
#
# YourPay Connect Gateway
#

print &$manager_page_header("YourPay Gateway","","","","");
...
<TR>
<TD WIDTH="55%">
User ID as registered with YourPay Connect.
</TD>
<TD WIDTH="45%">
...
<TR>
<TD WIDTH="55%">
Store ID as registered with YourPay Connect.
</TD>
<TD WIDTH="45%">
...
<TR>
<TD COLSPAN=2>
URL to the YourPay Connect server
</TD>
</TR>
...
<br>
<INPUT NAME="sc_yourpay_submit" TYPE="TEXT" SIZE=60 
VALUE='$sc_yourpay_submit'><br>
</TD>
</TR>
...
<br>
<INPUT NAME="sc_yourpay_change" TYPE="TEXT" SIZE=60 
VALUE='$sc_yourpay_change'><br>
</TD>
</TR>
...
Order Description:
<br>
<INPUT NAME="sc_yourpay_order_desc" TYPE="TEXT" SIZE=60 
VALUE='$sc_yourpay_order_desc'><br>
</TD>
</TR>
...
<br>
<TEXTAREA NAME="sc_yourpay_verify_message"
ROWS=4 COLS=65 wrap=soft>$sc_yourpay_verify_message</TEXTAREA>
</TD>
</TR>
...
<TEXTAREA NAME="sc_yourpay_top_message" 
cols="68" rows=8 
wrap=off>$sc_yourpay_top_message</TEXTAREA> <br><br>
</TD>
</TR>
...
<INPUT TYPE="HIDDEN" NAME="gateway" VALUE="YourPayConnect">
