...
(function ($) {
  ...
  window.InlineShortcodeView_vc_column = window.InlineShortcodeViewContainerWithParent.extend({
    ...
    setColumnClasses: function() {
      ...
      $content.removeClass('vc_col-sm-' + this.css_class_width  + ' vc_span' + this.css_class_width);
      if(!offset.match(/vc_col\-sm\-\d+/)) {
        this.$el.addClass('vc_col-sm-' + this.css_class_width  + ' vc_span' + this.css_class_width);
      }
    ...
    resize: function(e) {
      ...
      this.model.save({params: params}, {silent: true});
      this.$el.removeClass('vc_col-sm-' + old_width + ' vc_span' + old_width).addClass('vc_col-sm-' + this.css_class_width + ' vc_span' + this.css_class_width);
    },
