...
function wpb_translateColumnsCountToSpanClass( $grid_columns_count ) {
	...
	switch ( $grid_columns_count ) {
		case '1' :
			$teaser_width = 'vc_col-sm-12 vc_span12';
			break;
		case '2' :
			$teaser_width = 'vc_col-sm-6 vc_span6';
			break;
		case '3' :
			$teaser_width = 'vc_col-sm-4 vc_span4';
			break;
		case '4' :
			$teaser_width = 'vc_col-sm-3 vc_span3';
			break;
		case '5':
			$teaser_width = 'vc_col-sm-10 vc_span10';
			break;
		case '6' :
			$teaser_width = 'vc_col-sm-2 vc_span2';
			break;
	}
	//return $teaser_width;
...
function wpb_translateColumnWidthToSpan( $width, $front = true ) {
	...
	return $custom ? $custom : $new_w.' vc_' . $w;
}
