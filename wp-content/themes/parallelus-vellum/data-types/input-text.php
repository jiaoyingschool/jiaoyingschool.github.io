	...
	public function render_content( $vals = null ) {
		...
		if(isset($this->field->repeating) && $this->field->repeating == 'Yes'){		
			...
			<label>
				...
				<div class="customize-control-content">
					<input type="text" 
						class="input-text custom-data-type" <?php echo $section; ?> data-type="input-text" <?php $this->link(); ?> name="<?php echo $this->field->alias; ?>" value="<?php echo ( $vals != null ) ? $this->field->saved : (is_array($this->get_value())) ? '' : $this->get_value(); ?>"/>
				</div>
			</label>
			<?php
		}		
