			...
			<?php $custom_post_types = get_post_types(array('_builtin'=>false), 'object');
				foreach($custom_post_types as $key => $custom_post_type): 
					...
					<tr class="">
						...
						<td>
							<label><input class="input-check" type="checkbox" value="true" name="content-source-<?php echo $key; ?>" <?php echo (isset($settings["content-source-$key"]) && $settings["content-source-$key"] == 'true') ? 'checked' : ''; ?>> Enable <?php echo ucfirst($custom_post_type_label); ?></label>
						</td>
					</tr>					
				<?php endforeach ?>
		</tbody>
