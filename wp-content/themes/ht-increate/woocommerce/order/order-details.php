...
<header>
	<h3 class="col-title"><?php _e( 'Customer details', 'woocommerce' ); ?></h3>
</header>
...
<?php endif; ?>
		...
		<header class="title">
			<h3 class="col-title"><?php _e( 'Billing Address', 'woocommerce' ); ?></h3>
		</header>
		<address><p>
			<?php
...
<?php if ( get_option( 'woocommerce_ship_to_billing_address_only' ) === 'no' && get_option( 'woocommerce_calc_shipping' ) !== 'no' ) : ?>
	...
	<div class="col-2">
		...
		<header class="title">
			<h3 class="col-title"><?php _e( 'Shipping Address', 'woocommerce' ); ?></h3>
		</header>
		<address><p>
			<?php
