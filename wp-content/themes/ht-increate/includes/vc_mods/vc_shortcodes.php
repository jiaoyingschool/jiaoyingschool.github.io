...
---------------------------------------------------------- */
vc_map( array(
  "name"                    => __("Gap", "highthemes"),
  "base"                    => "ht_gap",
   "icon"        =>'ht-logo',
  "show_settings_on_create" => true,
  "description"             => __("Vertical gap with custom height.","highthemes"),
  "category"                => __('Content', 'highthemes'),
  "params"                  => array(
    array(
      "type" => "textfield",
      "heading" => __("Gap Height", "highthemes"),
      "param_name" => "gap_height",
      "description" => __("Enter value of gap without px - Default is 35", "highthemes")
    ),
      array(
         "type" => "textfield",
         "heading" => __("Extra class name", "highthemes"),
